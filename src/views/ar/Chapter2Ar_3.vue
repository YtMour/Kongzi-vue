  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text1">تماثيل كونفوشيوس خارج الصين
        </div>
       <img src="@/assets/Chapter3/page2/图画2.png" alt="" class="logo2" />
        <div class="text2">المؤتمر العالمي للدراسات الكونفوشيوسية
        </div>
        <div class="text3">النسخة الإيطالية من "محاورات كونفوشيوس"
        </div>
