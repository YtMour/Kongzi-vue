...
let nextLeft = '/ar/chapter5';
let nextR = '/ar/chapter7'; // 创建路由实例
onMounted(() => {
  const texts = [
...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        <div class="text1">في سنه الثلاثين، كان كونفوشيوس أول من أسس مدرسة خاصة، جاعلاً التعليم متاحاً للعامة. طبَّق مبدأ "التعليم وفقاً لقدرات الفرد" على طلابه، الذين انتشروا في شتى أنحاء المملكة. يُقال إن لديه ثلاثة آلاف طالب، منهم ٧٢ من الحكماء البارزين. كإرث تعليمي ثمين، لم ترسِ أفكار كونفوشيوس الأساس النظري للتعليم الصيني القديم فحسب، بل تخطت الجبال والبحار لتنتشر خارج الصين، مما أثر على يومنا هذا.
        </div>
       ...
       <img src="@/assets/Chapter1/page6/图画2.png" alt="" class="logo2" />
        <div class="text3">صورة "كونفوشيوس يُعلّم في شينغتان" - من كتاب "سجلات متنوعة للعائلة الشرقية" من عهد أسرة سونغ الملكية
        </div>
