...
let nextLeft = '/ar/chapter1';
let nextR = '/ar/chapter3';
// 点击事件，跳转到前言页面
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text1">كهف فوتسي عند سفح جبل نيشان، يُعتقد أنه مكان ولادة كونفوشيوس
        </div>
       <img src="@/assets/Chapter1/page2/夫子像.png" alt="" class="logo2" />
        <div class="text2">تمثال كونفوشيوس بارتفاع ٧٢ متراً على جبل نيشان
        </div>
