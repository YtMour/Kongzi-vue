...
let nextLeft = '/ar/foreword';
let nextR = '/ar/chapter1';
  ...
  <div id="app" data-v-app>
    <div class="wrapper" >  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="textbox3">
          <div class="text5">السماء لم تولد (جوني)، و (تشونغ) كانت ليلة طويلة</div>
          <div class="text6">جوهي جوهي</div>
        </div>
