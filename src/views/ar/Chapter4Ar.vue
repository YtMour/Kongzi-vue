...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        <div class="text1">
          عزم كونفوشيوس على التعلم منذ صغره، وأتقن الفنون الستة. في شبابه، سافر في أنحاء مملكة تشو
          حتى بلغ ولاية تشي، واستفسر من لاو تسي عن الآداب. في منتصف عمره، تولى مناصب حكومية وطاف في
