...
let nextLeft = '/ar/chapter3';
let nextR = '/ar/chapter5';
// 点击事件，跳转到前言页面
...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        <div class="text1">عزم كونفوشيوس على التعلم منذ صغره، وأتقن الفنون الستة. في شبابه، سافر في أنحاء مملكة تشو حتى بلغ ولاية تشي، واستفسر من لاو تسي عن الآداب. في منتصف عمره، تولى مناصب حكومية وطاف في شتى الأقاليم. أما في أواخر حياته، فقد عاد إلى ولاية لو حيث عكف على التعليم وتنقيح الكتب الكلاسيكية الستة.
        </div>
        <img src="@/assets/Chapter1/page4/图画1.png" alt="" class="logo1" />
        <div class="text2">لوحة جدارية من مقبرة هان في دونغبينغ، شاندونغ: كونفوشيوس يلتقي لاو تسي
        </div>
       <img src="@/assets/Chapter1/page4/图画2.png" alt="" class="logo2" />
        <div class="text3">"كونفوشيوس يتعلم العزف على قو تشين من شي شيانغ" - من كتاب "دراسة رسومات لطقوس المعبد المقدس" - محفوظ في متحف القصر الوطني في تايبيه
        </div>
