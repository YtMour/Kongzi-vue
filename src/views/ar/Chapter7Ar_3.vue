...
const handleLeftClick = () => {
  router.push('/ar/chapter6_3');  // 跳转到前言页面
...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        <div class="text1">هلموا نتضافر جهودنا، مستنيرين بحكمة كونفوشيوس، لنبني عالماً أكثر تناغماً وشمولية واستدامة. دعونا نجعل هذه الحكمة العريقة تشع بنور الوئام في خضم الموجة العصر الحديث، لتقود البشرية نحو مستقبل أكثر إشراقًا وجمالًا.
        </div>
        <div class="logo1">
          <img src="@/assets/Chapter3/page7/图画1.png" alt="" class="logo2" />
          
        </div>
        <div class="text2">أشجار السرو القديمة في معبد كونفوشيوس
