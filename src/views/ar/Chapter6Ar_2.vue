...
let nextLeft = '/ar/chapter5_2';
let nextR = '/ar/chapter7_2'; // 创建路由实例
onMounted(() => {
  const texts = [
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text2">الموسيقى: كان كونفوشيوس شغوفاً بالموسيقى، معتقداً أنها قادرة على صقل الطباع وتطهير القلب. دعا إلى "الموسيقى الراقية"، مؤكداً أنه ينبغي للموسيقى أن تحمل قيمة تعليمية وأهمية اجتماعية.
        </div>
