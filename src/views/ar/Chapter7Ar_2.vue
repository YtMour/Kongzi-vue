...
let nextLeft = '/ar/chapter6_2'
let nextR = '/ar/detail3' // 创建路由实例
onMounted(() => {
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        ...
        <div class="text1">
          صورة كونفوشيوس في "مشهد العزف على بان" - منقوشة على الحجر من عهد أسرة هان الملكية
        </div>
