  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <p class="text">&nbsp;&nbsp;&nbsp;&nbsp;في لوحة الحكمة التي تمتد عبر آلاف السنين، يبرز كونفوشيوس بأفكاره المتمحورة حول "الإنسانية"، ومعاييره القائمة على "الآداب والموسيقى"، داعياً إلى " الوئام رغم الاختلاف"، ومؤسساً لمبدأ "التعليم للجميع دون تمييز". لم يكن فكره العميق والشامل مجرد حجر الأساس للحضارة الصينية، بل تجاوز الجبال والبحار ليصبح ثروة روحية مشتركة للبشرية جمعاء.
        </p>
        <p class="text2">&nbsp;&nbsp;&nbsp;&nbsp;سيأخذنا هذا المعرض في رحلة عبر الزمن من خلال ثلاثة فصول، مستعينًا بالصور لرواية القصة، لنستشعر معاً السحر الأبدي لأفكار كونفوشيوس، ونمد جسورًا للتواصل الروحي، ونستنير بضوء الحكمة، ونرسم ملامح المستقبل.
        </p>
