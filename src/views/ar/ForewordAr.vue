    ...
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        ...
        <p class="text">
          ...
          رغم الاختلاف"، ومؤسساً لمبدأ "التعليم للجميع دون تمييز". لم يكن فكره العميق والشامل مجرد
          حجر الأساس للحضارة الصينية، بل تجاوز الجبال والبحار ليصبح ثروة روحية مشتركة للبشرية جمعاء.
        </p>
        <p class="text2">
          &nbsp;&nbsp;&nbsp;&nbsp;سيأخذنا هذا المعرض في رحلة عبر الزمن من خلال ثلاثة فصول، مستعينًا
