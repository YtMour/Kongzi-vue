...
let nextLeft = '/ar/chapter2';
let nextR = '/ar/chapter4';
// 点击事件，跳转到前言页面
// 
onMounted(() => {
  const texts = [
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text1">صورة "كونفوشيوس وهو يُعلِّم" – يُعتقد أنها نقش حجري من عهد أسرة تانغ الملكية، محفوظة حالياً في قاعة الآثار المقدسة بمعبد كونفوشيوس في تشيوفو
        </div>
       <img src="@/assets/Chapter1/page3/图画.png" alt="" class="logo2" />
        <div class="text2">"تسنغ تسي يسأل كونفوشيوس عن البر" - من عهد أسرة سونغ الملكية
        </div>
