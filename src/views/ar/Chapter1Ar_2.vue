...
let nextLeft = '/ar/detail2';
let nextR = '/ar/chapter2_2';
// 点击事件，跳转到前言页面
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text1">لم يكن كونفوشيوس مفكراً عميقاً فحسب، بل تجسدت فلسفته الحياتية في كل مناحي الحياة اليومية، مثل: "الملبس والمأكل والسكن والتنقل والموسيقى"، كان كونفوشيوس يراعي الآداب في كل منها، مجسداً بذلك القيم السامية للأفكار الكونفوشيوسية.
        </div>
        <div class="text2">الملابس</div>
