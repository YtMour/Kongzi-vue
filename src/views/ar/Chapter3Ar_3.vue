...
let nextLeft = '/ar/chapter2_3';
let nextR = '/ar/chapter4_3';
// 点击事件，跳转到前言页面
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text1">في عصرنا الحالي المليء بالتحديات والتغيرات، لم تعد حكمة كونفوشيوس مجرد صدى للتاريخ، بل هي منارة للمستقبل، تقدم منظوراً وحلولاً فريدة للقضايا العالمية. إنها تحثنا على التفكير في العلاقات المتشابكة: بين الإنسان والطبيعة، وبينه وبين المجتمع، وفيما بين البشر أنفسهم، داعية إلى تعايش يسوده الوئام والشمول، مما يضخ قوة لا تنضب للسلام والتنمية العالمية.
        </div>
       <img src="@/assets/Chapter3/page3/图画1.png" alt="" class="logo1" />
        <div class="text2">زوار أجانب أمام بوابة قاعة داتشنغ
        </div>
