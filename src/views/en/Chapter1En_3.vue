...
let nextLeft = '/en/detail3';
let nextR = '/en/chapter2_3';
// 点击事件，跳转到前言页面
// 
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        ...
        <div class="text1">International friends performing the "First Writing Ceremony" for children
        </div>
        <div class="text2">Scene from the launch event for the Maltese edition of the "Analects"
        </div>
