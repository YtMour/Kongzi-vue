...
let nextLeft = '/en/chapter4_2';
let nextR = '/en/chapter6_2';
// 点击事件，跳转到前言页面
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text2">"Extended Records of the Ancestral Court": Painting of Confucius Riding in a Carriage, Song Dynasty
        </div>

        <div class="text3">Throughout his life, Confucius traveled extensively across various states, spreading his ideas. His travels were not only for seeking knowledge but also for practicing his political ideals. During his journeys, he always maintained the demeanor of a gentleman, respecting others and being humble and courteous.
        </div>
          <img src="@/assets/Chapter2/page5/图画2.png" alt="" class="logo2" />
       <img src="@/assets/Chapter2/page5/图画3.png" alt="" class="logo3" />
        <div class="text4">Mount Tai in Shandong, filled with historical sites associated with Confucius
