...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        <div class="text1">
          From life philosophy to governance, Confucius' wisdom has a profound and far-reaching
          influence. His thoughts are deep and extensive. Centered on benevolence, regulated by
          rites and music, and utilizing the Doctrine of the Mean as a method, he guided people to
          build a harmonious and ideal world. The Confucian thought system established by Confucius
