...
let nextLeft = '/en/chapter4';
let nextR = '/en/chapter6';
// 点击事件，跳转到前言页面
...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        <div class="text1">From life philosophy to governance, Confucius' wisdom has a profound and far-reaching influence. His thoughts are deep and extensive. Centered on benevolence, regulated by rites and music, and utilizing the Doctrine of the Mean as a method, he guided people to build a harmonious and ideal world. The Confucian thought system established by Confucius is the crystallization of Chinese history and culture and serves as the main axis of traditional Chinese culture.
        </div>
        <img src="@/assets/Chapter1/page5/图画1.png" alt="" class="logo1" />
        <div class="text2">Hall of Great Achievement, the main hall of the Confucius Temple in Qufu, embodies the meaning of Confucius being as the "Great Accomplisher." It was originally built during the Tang Dynasty (618-907) and reconstructed during the Yongzheng period of the Qing Dynasty (1722-1735).
        </div>
       <img src="@/assets/Chapter1/page5/图画2.png" alt="" class="logo2" />
        <div class="text3">Dragon Pillar of the Hall of Great Achievement
