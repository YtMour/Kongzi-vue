...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        <div class="text1">
          Let us join hands and, inspired by the teachings of Confucius, work together to build a
          more harmonious, inclusive, and sustainable world. May this millennia-old wisdom shine
          with the light of unity in the waves of the new era, guiding humanity toward a brighter
          future.
        </div>
        <div class="logo1">
          <img src="@/assets/Chapter3/page7/图画1.png" alt="" class="logo2" />
        </div>
        <div class="text2">Ancient cypress trees in the Confucius Temple</div>
      </div>
      <div class="btnbox">
