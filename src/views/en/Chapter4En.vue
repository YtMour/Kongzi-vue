...
let nextLeft = '/en/chapter3';
let nextR = '/en/chapter5';
// 点击事件，跳转到前言页面
...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        <div class="text1">Confucius, aspired to learn in his youth, mastered the Six Arts. In his early adulthood, he traveled to Zhou and Qi, seeking knowledge from Lao Zi. As a middle-aged man, he served in government and traveled among various states. In his later years, he returned to Lu to promote education and compile the Six Classics.
        </div>
        <img src="@/assets/Chapter1/page4/图画1.png" alt="" class="logo1" />
        <div class="text2">Han Dynasty mural from a tomb in Dongping, Shandong: Confucius meeting Lao Zi
        </div>
       <img src="@/assets/Chapter1/page4/图画2.png" alt="" class="logo2" />
        <div class="text3">Painting of rituals in the Sacred Temple: Confucius learning qin (a seven-stringed plucked instrument) from Shi Xiang, collection of the National Palace Museum, Taipei
        </div>
