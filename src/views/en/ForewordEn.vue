    ...
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        ...
        <p class="text">
          ...
          uniformity" and initiated "education without discrimination." His profound and
          far-reaching thoughts not only shaped the backbone of Chinese civilization but also
          transcended mountains and seas, becoming a shared spiritual treasure of all humanity.
        </p>
        <p class="text2">
          &nbsp;&nbsp;This exhibition will narrate through images, divided into three chapters,
          guiding everyone through ancient and modern times to collectively experience the eternal
