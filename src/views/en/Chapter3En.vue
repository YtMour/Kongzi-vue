  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        ...
        <div class="text1">
          "Confucius Teaching", allegedly a Tang Dynasty stone carving, now preserved in the Sacred
          Site Hall of the Confucius Temple in Qufu
        </div>
        <img src="@/assets/Chapter1/page3/imga2.png" alt="" class="logo2" />
        <div class="text2">"Zengzi Inquiring about Filial Piety from Confucius", Song Dynasty</div>
      </div>
      <ButtonBox
