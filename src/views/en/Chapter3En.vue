...
let nextLeft = '/en/chapter2';
let nextR = '/en/chapter4';
// 点击事件，跳转到前言页面
// 
onMounted(() => {
  const texts = [
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text1">"Confucius Teaching", allegedly a Tang Dynasty stone carving, now preserved in the Sacred Site  Hall of the Confucius Temple in Qufu
        </div>
       <img src="@/assets/Chapter1/page3/图画.png" alt="" class="logo2" />
        <div class="text2">"Zengzi Inquiring about Filial Piety from Confucius", Song Dynasty
