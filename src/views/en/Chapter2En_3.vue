...
let nextLeft = '/en/chapter1_3';
let nextR = '/en/chapter3_3';
// 点击事件，跳转到前言页面
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text1">Confucius statues overseas

        </div>
       <img src="@/assets/Chapter3/page2/图画2.png" alt="" class="logo2" />
        <div class="text2">World Congress of Confucianism

        </div>
        <div class="text3">Italian edition of the "Analects"
