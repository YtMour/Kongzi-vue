...
let nextLeft = '/en/foreword';
let nextR = '/en/chapter1';
  ...
  <div id="app" data-v-app>
    <div class="wrapper" >  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="textbox2">
          <div class="text2">Life and

          </div>
          <div class="text3">Thoughts</div>
          <div class="text4">of Confucius</div>
        </div>

        <div class="textbox3">
          <div class="text5">Heaven does not produce Zhong Ni, eternity is like a long night</div>
          <div class="text6">-- Zhu Xi's Zhuzi Language Category</div>
        </div>
