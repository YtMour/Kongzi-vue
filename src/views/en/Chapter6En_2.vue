...
let nextLeft = '/en/chapter5_2';
let nextR = '/en/chapter7_2'; // 创建路由实例
onMounted(() => {
  const texts = [
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text2"> Confucius loved music deeply, believing that it could cultivate one's character and purify the soul. He advocated for "elegant music," believing that music should possess educational significance and social value.
        </div>
