...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        <div class="text1">
          Finalmente, unámonos, inspirados por el pensamiento de Confucio, para construir juntos un
          mundo más armonioso, inclusivo y sostenible. Que esta sabiduría milenaria ilumine con la
