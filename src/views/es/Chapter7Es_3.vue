...
const handleLeftClick = () => {
  router.push('/es/chapter6_3');  // 跳转到前言页面
...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        <div class="text1">Finalmente, unámonos, inspirados por el pensamiento de Confucio, para construir juntos un mundo más armonioso, inclusivo y sostenible. Que esta sabiduría milenaria ilumine con la luz de la armonía en esta nueva era, guiando a la humanidad hacia un futuro mejor.
        </div>
        <div class="logo1">
          <img src="@/assets/Chapter3/page7/图画1.png" alt="" class="logo2" />
          
        </div>
        <div class="text2">Los antiguos cipreses en el Templo de Confucio
