  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        ...
        <div class="text2">
          La música ocupaba un lugar especial en la filosofía de Confucio, quien consideraba que
          tenía el poder de purificar el alma y formar el carácter. Abogaba por la "música elevada",
