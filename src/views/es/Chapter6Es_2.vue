...
let nextLeft = '/es/chapter5_2';
let nextR = '/es/chapter7_2'; // 创建路由实例
onMounted(() => {
  const texts = [
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text1">Música</div>
        
        <div class="text2"> La música ocupaba un lugar especial en la filosofía de Confucio, quien consideraba que tenía el poder de purificar el alma y formar el carácter. Abogaba por la "música elevada", que debía poseer un valor educativo y social.
        </div>
