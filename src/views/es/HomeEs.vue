...
const handleRightClick = () => {
  router.push({ path: '/es/foreword' }) // 跳转到前言页面
  window.scrollTo(0, 0)
}
</script>
...
.logo4 {
  /* Rito y Música: El Intercambio Cultural de Confucio */
