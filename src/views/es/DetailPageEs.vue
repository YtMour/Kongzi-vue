...
let nextLeft = '/es/foreword';
let nextR = '/es/chapter1';
  ...
  <div id="app" data-v-app>
    <div class="wrapper" >  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="textbox1">
          <div class="text">El primer capítulo</div>
          <div class="xian1"></div>
        </div>
        <div class="textbox2">
          <div class="text2">La Vida y

          </div>
          <div class="text3">el Pensamiento</div>
          <div class="text4">de Confucio</div>
        </div>

        <div class="textbox3">
          <div class="text5">Cuando el cielo no produce un zhonni, todos los días son como una larga noche</div>
          <div class="text6">- zhu xi, clases de lenguas zhuzi</div>
        </div>
...
.animation3 {
  animation: fadeInOut 7s ease-in-out 1;
  animation-fill-mode: forwards;
}
html, body {
  margin: 0;
...
.background {
  ...
  width: 100%;
  height: 100%;
  background-image: url('@/assets/Chapter1/ArticleBG.png');
