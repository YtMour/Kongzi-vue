...
let nextLeft = '/es/detail2';
let nextR = '/es/chapter2_2';
// 点击事件，跳转到前言页面
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text1">Confucio no solo fue un destacado pensador, sino que también aplicaba su filosofía a los aspectos más cotidianos de la vida, integrando sus enseñanzas en áreas como la "ropa, comida, vivienda, transporte y música". Siempre actuaba conforme a los ritos, demostrando los altos estándares morales del confucianismo.
        </div>
        <div class="text2">Ropa</div>
