...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        <div class="text1">
          Desde su juventud, Confucio se entregó con fervor al estudio, dominando las seis artes
          clásicas. Viajó por el estado de Qi y estudió ceremonias junto a Laozi. Durante su
          madurez, desempeñó diversos cargos oficiales y continuó viajando por varios estados, hasta
