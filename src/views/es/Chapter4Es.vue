...
let nextLeft = '/es/chapter3';
let nextR = '/es/chapter5';
// 点击事件，跳转到前言页面
...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        <div class="text1">Desde su juventud, Confucio se entregó con fervor al estudio, dominando las seis artes clásicas. Viajó por el estado de Qi y estudió ceremonias junto a Laozi. Durante su madurez, desempeñó diversos cargos oficiales y continuó viajando por varios estados, hasta que, en su vejez, regresó a su tierra natal donde fundó escuelas y recopiló textos clásicos.
        </div>
        <img src="@/assets/Chapter1/page4/图画1.png" alt="" class="logo1" />
        <div class="text2">Mural "Confucio encontrándose con Laozi", hallado en una tumba de la dinastía Han (206 a.C. - 220 d.C.) en Dongping, Shandong

        </div>
       <img src="@/assets/Chapter1/page4/图画2.png" alt="" class="logo2" />
        <div class="text3">"Estudio sobre los Ritos del Templo Sagrado: Confucio Aprendiendo a Tocar el Qin con Shixiang" en el Museo del Palacio de Taipéi
        </div>
