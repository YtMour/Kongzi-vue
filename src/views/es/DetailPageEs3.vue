...
let nextLeft = '/es/chapter7_2';
let nextR = '/es/chapter1_3';
onMounted(() => {
  const texts = [
    ...
    <div class="wrapper">
      ...
      <div class="content">
        ...
        <div class="textbox2">
          ...
          <div class="text2">La Influencia
          </div>
          <div class="text3">Global de la</div>
          <div class="text4">Cultura Confuciana</div>
        </div>

        <div class="textbox3">
          <div class="text5">El pensamiento confucio tiene una connotación extremadamente amplia, es la cultura China y también un símbolo de la cultura oriental. Confucio no solo pertenece a China, sino también al mundo</div>
          <div class="text6">- académico, mauldorf (alemania)</div>
        </div>
