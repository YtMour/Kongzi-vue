  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        ...
        <div class="text1">
          La Cueva del Maestro, situada al pie del monte Ni, es considerada, según la leyenda, el
          lugar de nacimiento de Confucio
        </div>
        <img src="@/assets/Chapter1/page2/imga2.png" alt="" class="logo2" />
        <div class="text2">Estatua de Confucio en el monte Ni de 72 metros de altura</div>
      </div>
      <ButtonBox
