...
let nextLeft = '/es/chapter1';
let nextR = '/es/chapter3';
// 点击事件，跳转到前言页面
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text1">La Cueva del Maestro, situada al pie del monte Ni, es considerada, según la leyenda, el lugar de nacimiento de Confucio
        </div>
       <img src="@/assets/Chapter1/page2/夫子像.png" alt="" class="logo2" />
        <div class="text2">Estatua de Confucio en el monte Ni de 72 metros de altura
