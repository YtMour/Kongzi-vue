...
const handleRightClick = () => {
  router.push('/kr/foreword') // 跳转到前言页面
  window.scrollTo(0, 0)
}
</script>
...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <!-- 背景图容器 -->
      <div class="content">
        <img src="@/assets/shouye/kr.png" alt="" class="logo1" />
        <img src="@/assets/shouye/yykz.png" alt="" class="logo2" />
        <img src="@/assets/shouye/liyue.png" alt="" class="logo3" />
        <img src="@/assets/shouye/kr2.png" alt="" class="logo4" />
        <!-- <div class="logo4">공자국제문화교류 활동</div> -->
