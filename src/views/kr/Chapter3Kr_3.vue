...
let nextLeft = '/kr/chapter2_3';
let nextR = '/kr/chapter4_3';
// 点击事件，跳转到前言页面
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text1">도전과 변혁의 오늘 이 시대에 공자의 지혜는 역사의 메아리일 뿐만 아니라 미래를 위한 등대로 전 글로블 문제에 관한 독특한 관점과 해법을 제시하여 인간과 자연, 인간과 사회 및 인간 사이의 관계를 반성하게 하는 동시에 화합하고 포용하며 서로 받아들이는 함께하는 방식을 권유하며, 세계 평화와 발전에 무궁무진한 힘을 불어넣고 있다.
        </div>
       <img src="@/assets/Chapter3/page3/图画1.png" alt="" class="logo1" />
        <div class="text2">대성전 앞 해외 관광객들
        </div>
