...
let nextLeft = '/kr/foreword';
let nextR = '/kr/chapter1';
// 点击事件，跳转到前言页面
const goToNextPage = () => {
  router.push('');  // 跳转到前言页面
  window.scrollTo(0, 0);
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage" >  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="textbox1">
          <div class="text">제1장</div>
          <div class="xian1"></div>
        </div>
        <div class="textbox2">
          <div class="text2">공자의
          </div>
          <div class="text3">생애와</div>
          <div class="text4">공자사상</div>
        </div>

        <div class="textbox3">
          <div class="text5">하늘이 중니를 낳지 않으면 만고가 기나긴 밤과 같다</div>
          <div class="text6">-주희 「 주자어류 」</div>
        </div>
