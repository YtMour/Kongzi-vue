...
let nextLeft = '/kr/detail2';
let nextR = '/kr/chapter2_2';
// 点击事件，跳转到前言页面
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text1">공자는 심오한 사상가일 뿐더러 그의 생활 철학도 일상생활에 이모저모로 구현되어 있다. 옷이나 음식,주거,행동,음악(衣食住行樂)등 면에서 공자는 모두 예의에 따라 행하여 유가의 고상한 풍격을 보여주었다.
        </div>
