...
let nextLeft = '/kr/chapter1_2';
let nextR = '/kr/chapter3_2';
// 点击事件，跳转到前言页面
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text1">옷차림의 단정함을 강조한 공자는 "군자정기의관,존기첨시(君子正其衣冠，尊其瞻視)"라며 이는 타인에 대한 존중일 뿐만 아니라 자기 수양의 반영이기도 한다고 주장하였다. 공자는 예의에 맞는 관을 쓰고, 상황에 따라 예관을 달리하여 유가 예절의 미를 보여주었다.</div>
       <img src="@/assets/Chapter2/page2/图画1.png" alt="" class="logo1" />
        <div class="text2">공자의 후손들이 수집한 중국 명나라의 전통 복식
        </div>
          <div class="text3">'노국(魯國) 사구(司寇)직 시기 공자상' 명·작가 미상
