...
const handleLeftClick = () => {
  router.push('/kr/chapter6_3');  // 跳转到前言页面
};
 // 创建路由实例
onMounted(() => {
  const texts = [
...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        <div class="text1">공자 사상의 제시로 보다 조화롭고 포용적이며 지속 가능한 세상을 만들기 위해 손 잡고 함께 나아가자. 천년을 뛰어넘는 이 지혜로 하여금 새 시대의 물결 속에서 화합의 빛을 피워 인류를 더 나은 미래로 이끌게 하자.
        </div>
        <div class="logo1">
          <img src="@/assets/Chapter3/page7/图画1.png" alt="" class="logo2" />
          
        </div>
        <div class="text2">공자묘의 측백나무
        </div>
