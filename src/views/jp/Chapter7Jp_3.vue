...
const handleLeftClick = () => {
  router.push('/jp/chapter6_3');  // 跳转到前言页面
};
 // 创建路由实例
onMounted(() => {
  const texts = [
...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        <div class="text1">私たちは手を携えて歩み、孔子の思想にインスピレーションを受け、より調和のとれた寛容で持続可能な世界を共に構築しましょう。数千年にわたるこの知恵を、新しい時代の波の中で光り輝かせ、人類をさらにすばらしい未来へと導きます。
        </div>
        <div class="logo1">
          <img src="@/assets/Chapter3/page7/图画1.png" alt="" class="logo2" />
          
        </div>
        <div class="text2">孔廟内のコノテガシワの古木
        </div>
