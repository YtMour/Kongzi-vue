  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <p class="text">&nbsp;&nbsp;&nbsp;&nbsp;数千年を経た知恵の絵巻の中で、孔子は「仁」を中心とし、「礼儀・音楽」を規範として、「和して同ぜず」を唱え、「教えありて類なし」を掲げました。その思想は深く広範囲にわたり、華夏文明の背骨を形作っただけでなく、海や山を越え、全人類が共有する精神的財産となりました。
        </p>
        <p class="text2">&nbsp;&nbsp;&nbsp;&nbsp;今回の展覧会は画像を用いて物語を紐解き、3つの章により古今を乗り越え皆様を導いて、共に孔子の思想の永遠の魅力を感じ取り、心のコミュニケーションの架け橋を作り、知恵の光を互いに学び、未来への道を模索しましょう。
        </p>
