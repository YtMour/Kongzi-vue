...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        <div class="text1">
          Dans son enfance, Confucius aspirait à étudier et à devenir compétent dans les six arts ;
          dans sa jeunesse, il a voyagé dans Zhou et s'est rendu à Qi, et s'est instruit auprès de
          Laozi sur les rites ; à l'âge mûr, il a cherché à exercer des fonctions politiques et a
