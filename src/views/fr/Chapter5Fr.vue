...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        <div class="text1">
          De la philosophie de la vie à la gouvernance du pays, la sagesse de Confucius a eu un
          impact profond, et ses pensées sont extrêmement étendues. Avec la bonté comme noyau, les
          rites et la musique comme normes, et le juste milieu comme méthode, il a guidé les gens
          pour construire un monde beau de concorde. Le système de pensée confucéen fondé par
