...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        <div class="text1">
          En cette époque de défis et de changements, la sagesse de Confucius n'est pas seulement un
          écho de l'histoire, mais aussi un phare pour l'avenir, offrant des perspectives et des
          solutions uniques aux problèmes mondiaux. Elle nous incite à réfléchir à la relation entre
          l'homme et la nature, l'homme et la société, et l'homme et l'homme, et prône une
...
.text1 {
  /* 在当今这个充满挑战与变革的时代，孔子的智慧不仅是历史的回响，更是未来的灯塔，为解决全球性问题提供了独特的视角与方案；它促使我们反思人与自然、人与社会、人与人之间的关系，倡导以和为贵、兼容并蓄的相处之道，为世界和平与发展注入不竭的动力。 */
