...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        <div class="text1">
          L'organisation d'une série d'activités telles que le Forum international du confucianisme
          et le Festival culturel de Confucius a permis d'améliorer la compréhension et la
          reconnaissance de la culture de Confucius parmi les peuples de tous les pays, et dans le
          cadre de sa préservation, de son héritage et de son développement, ces activités ont pu
        ...
        <div class="text3">
          ...
          découvrir les coutumes du Nouvel An
        </div>
        <div class="text4">Wanren Gongqiang, dans le temple de Confucius à Qufu</div>
      </div>
      <ButtonBox
