...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        <div class="text1">
          Unissons nos efforts pour construire un monde plus harmonieux, plus inclusif et plus
          durable en nous inspirant de la pensée de Confucius. Faisons en sorte que cette sagesse,
          qui a traversé des milliers d'années, s'épanouisse en une lumière d'harmonie dans les
