  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        ...
        <div class="text2">
          Confucius aimait la musique et pensait qu'elle pouvait cultiver le tempérament et purifier
          l'âme. Il prônait une « musique élégante » et estimait que la musique devait avoir une
          valeur éducative et sociale.
        </div>
