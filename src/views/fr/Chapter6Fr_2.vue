...
let nextLeft = '/fr/chapter5_2';
let nextR = '/fr/chapter7_2'; // 创建路由实例
onMounted(() => {
  const texts = [
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text1">Musique</div>
        
        <div class="text2">Confucius aimait la musique et pensait qu'elle pouvait cultiver le tempérament et purifier l'âme. Il prônait une « musique élégante » et estimait que la musique devait avoir une valeur éducative et sociale.</div>
