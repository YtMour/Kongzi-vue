...
let nextLeft = '/rf/foreword';
let nextR = '/rf/chapter1';
  ...
  <div id="app" data-v-app>
    <div class="wrapper" >  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="textbox1">
          <div class="text">Глава 1</div>
          <div class="xian1"></div>
        </div>
        <div class="textbox2">
          <div class="text2">Жизнь  

          </div>
          <div class="text3">и идеи</div>
          <div class="text4">Конфуция</div>
        </div>

        <div class="textbox3">
          <div class="text5">Если небеса не родят Чжунни, вечность будет подобна долгой ночи.</div>
          <div class="text6">—— «Чжу Цзы Ю Лэй» Чжу Си</div>
        </div>
