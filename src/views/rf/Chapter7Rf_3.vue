...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        <div class="text1">Вдохновляясь идеями Конфуция, давайте объединим усилия, чтобы строить более гармоничный, инклюзивный и устойчивый мир. Пусть мудрость, преодолевшая тысячелетия, засияет светом гармонии в волнах новой эпохи и ведет человечество к более совершенному будущему.
        </div>
        <div class="logo1">
          <img src="@/assets/Chapter3/page7/图画1.png" alt="" class="logo2" />
          
        </div>
        <div class="text2">Древние кипарисы в храме Конфуция
