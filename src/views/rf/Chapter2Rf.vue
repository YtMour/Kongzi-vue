...
let nextLeft = '/rf/chapter1';
let nextR = '/rf/chapter3';
// 点击事件，跳转到前言页面
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text1">Пещера Фуцзы, расположенная у подножия горы Нишань, по преданию, является местом рождения Конфуция.
        </div>
       <img src="@/assets/Chapter1/page2/夫子像.png" alt="" class="logo2" />
        <div class="text2">72-метровая статуя Конфуция на горе Нишань
