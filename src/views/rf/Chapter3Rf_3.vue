...
let nextLeft = '/rf/chapter2_3';
let nextR = '/rf/chapter4_3';
// 点击事件，跳转到前言页面
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text1">В наше время, полном вызовов и изменений, мудрость Конфуция не только отголосок истории, но и маяк для будущего, предлагающий уникальные взгляды и решения для глобальных проблем. Она побуждает нас размышлять о взаимосвязях между человеком и природой, человеком и обществом, а также между людьми, пропагандируя ценность гармонии и инклюзивного сосуществования, что вносит неоценимый вклад в развитие цивилизаций и укрепление мира.
        </div>
       <img src="@/assets/Chapter3/page3/图画1.png" alt="" class="logo1" />
        <div class="text2">Иностранные посетители перед входом в зал Великого достижения
