...
let nextLeft = '/rf/chapter5_3';
let nextR = '/rf/chapter7_3';  // 创建路由实例
onMounted(() => {
  const texts = [
...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        <div class="logo2">
       <img src="@/assets/Chapter3/page6/imga2.png" alt="" class="img2" />
      </div>
        <div class="logo1">
        <img src="@/assets/Chapter3/page6/imga1.png" alt="" class="img1" />
      </div>
