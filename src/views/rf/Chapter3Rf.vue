  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        ...
        <div class="text1">
          Считается, что каменый барельеф «Конфуций ведет обучение» был создан во времена династии
          Тан, в настоящее время хранится в храме Конфуция в Цюйфу в зале священных реликвий.
        </div>
        <img src="@/assets/Chapter1/page3/imga2.png" alt="" class="logo2" />
        <div class="text2">«Цзэн-цзы обращается к Конфуцию», династия Сун</div>
      </div>
      <ButtonBox
