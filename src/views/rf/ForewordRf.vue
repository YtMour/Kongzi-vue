  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <p class="text">&nbsp;&nbsp;&nbsp;&nbsp;Конфуций, взяв за основу принципы «жэнь» (гуманность), «ли» и «юэ» (этикет и музыка), продвигал идеи «гармонии в многообразии» и «образование для всех». Его глубокие и далеко идущие идеи стали основой китайской цивилизации, более того, получили широкое распространение далеко за пределами Китая, став духовным достоянием всего человечества.
        </p>
        <p class="text2">&nbsp;&nbsp;&nbsp;&nbsp;Эта выставка картин рассказывает историю конфуцианства от древности к современности в трех главах. Мы познакомимся с идеями Конфуция, построим мост для духовного общения, познаем свет мудрости, который освещает путь в будущее.
        </p>
