...
const handleRightClick = () => {
  router.push({ path: '/rf/foreword' }) // 跳转到前言页面
  window.scrollTo(0, 0)
}
</script>
...
.logo4 {
  /* Мероприятие по международному распространению культуры Конфуция */
