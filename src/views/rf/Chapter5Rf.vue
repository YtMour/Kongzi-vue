...
let nextLeft = '/rf/chapter4';
let nextR = '/rf/chapter6';
// 点击事件，跳转到前言页面
...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        <div class="text1">Мудрость Конфуция оказала глубокое влияние на все стороны общественной  жизни: от жизненной философии до государственного управления. Конфуций использовал гуманность («жэнь») как основу, этикет и музыку («ли» и «юэ») как норму,  а умеренность как метод, он направлял людей к построению гармоничного и великого (совершенного) мира. Конфуцианство - учение, созданное Конфуцием, является квинтэссенцией китайской истории и культуры и служит главной осью традиционной китайской культуры.
        </div>
        <img src="@/assets/Chapter1/page5/图画1.png" alt="" class="logo1" />
        <div class="text2">Дачэньдин - главный зал храма Конфуция в Цюйфу, носит название в честь концепции «собирать великое». Он был основан в эпоху Тан (618-907 г. до н.э.) и перестроен в период Юнчжэна династии Цин (1722-1735 г. до н.э.).
        </div>
       <img src="@/assets/Chapter1/page5/图画2.png" alt="" class="logo2" />
        <div class="text3">Столбы с драконами зала Великого достижения
