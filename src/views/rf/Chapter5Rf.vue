...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">
      ...
      <div class="content">
        <div class="text1">
          Мудрость Конфуция оказала глубокое влияние на все стороны общественной жизни: от жизненной
          философии до государственного управления. Конфуций использовал гуманность («жэнь») как
          основу, этикет и музыку («ли» и «юэ») как норму, а умеренность как метод, он направлял
          людей к построению гармоничного и великого (совершенного) мира. Конфуцианство - учение,
