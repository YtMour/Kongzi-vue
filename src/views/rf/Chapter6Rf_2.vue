  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text2">Конфуций страстно любил музыку и считал, что она может развивать характер и очищать душу. Он выступал за «церемониальную музыку», полагая, что музыка должна иметь образовательное значение и социальную ценность.
        </div>
