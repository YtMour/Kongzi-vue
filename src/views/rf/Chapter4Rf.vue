...
let nextLeft = '/rf/chapter3';
let nextR = '/rf/chapter5';
// 点击事件，跳转到前言页面
...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        <div class="text1">Конфуций в молодости стремился к знаниям, овладел шестью искусствами, в юности путешествовал по царствам Чжоу и Ци, учился этикету у Лао-цзы, в зрелом возрасте поступил на государственную службу и путешествовал по различным царствам, а в старости вернулся в Лу, основал школу и составил шесть канонов.
        </div>
        <img src="@/assets/Chapter1/page4/图画1.png" alt="" class="logo1" />
        <div class="text2"> «Конфуций встречает Лао-цзы», фреска на стене могилы времен династи Хань в Дунпине, провинция Шаньдун
        </div>
       <img src="@/assets/Chapter1/page4/图画2.png" alt="" class="logo2" />
        <div class="text3">Картина «Исследование церемоний в храме: Конфуций учится играть на цинь у учителя Сянь» хранится в Национальном дворце-музее Тайбэя
        </div>
