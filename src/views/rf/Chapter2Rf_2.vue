...
let nextLeft = '/rf/chapter1_2';
let nextR = '/rf/chapter3_2';
// 点击事件，跳转到前言页面
  ...
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        ...
        <div class="text1">Конфуций придавал большое значение аккуратности одежды и головного убора. Он считал, что «достойный человек должен носить свою одежду и головной убор, уважая свой внешний вид», выражая  уважение к другим людям и проявляя внутреннее самосовершенствование. Сам он беспрекословно следовал этикету и носил разные головные уборы в зависимости от ситуации, демонстрируя красоту конфуцианских традиций.</div>
       <img src="@/assets/Chapter2/page2/imga1.png" alt="" class="logo1" />
        <div class="text2">Традиционные китайские костюмы династии Мин, собранные потомками Конфуция
        </div>
          <div class="text3">«Конфуций в наряде советника по судебным делам», автор не известен, династия Мин
          </div>
