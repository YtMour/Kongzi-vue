...
// 点击事件，跳转到前言页面
const goToNextPage = () => {
  router.push('/cn/detail3');  // 跳转到前言页面
};
</script>
...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        <img src="@/assets/第二章/第七页/图画1.png" alt="" class="logo1" />
        <div class="text1">汉画像石“击磬图”孔子像</div>
       <img src="@/assets/第二章/第七页/图画2.png" alt="" class="logo2" />
