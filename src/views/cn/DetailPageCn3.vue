...
<template>
  <div id="app" data-v-app>
    <div class="wrapper" @click="goToNextPage">  <!-- 点击整个页面 -->
      ...
      <div class="content">
        <img src="@/assets/第三章/鸽子.png" alt="" class="logo1" />
        <img src="@/assets/第三章/永远.png" alt="" class="logo2" />
        <img src="@/assets/第三章/大圆.png" alt="" class="logo3" />
        <img src="@/assets/第三章/小圆.png" alt="" class="logo4" />
        <div class="textbox1">
        ...
        <img src="@/assets/第三章/礼乐.png" alt="" class="logo5" />
        <img src="@/assets/第三章/读书.png" alt="" class="logo6" />
